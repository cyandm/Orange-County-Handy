...
$rows = array_filter([
	...
	['label' => __('Subject', 'orange-county-handy'), 'value' => $subject, 'href' => ''],
...
<head>
	...
	<title><?php esc_html_e('New contact message', 'orange-county-handy'); ?></title>
</head>
					...
					<tr>
						<td style="background-color:#151515; padding:24px;">
							...
							<p style="margin:6px 0 0; font-size:22px; font-weight:700; color:#ffffff;">
								<?php esc_html_e('New contact message', 'orange-county-handy'); ?>
							</p>
						</td>
					</tr>
						...
						<td style="padding:24px;">
							...
							<table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0">
								<?php foreach ($rows as $row) : ?>
									<tr>
										<td style="padding:10px 0; border-bottom:1px solid #d3d3d3; font-size:13px; font-weight:400; color:#5b5b5b; width:120px; vertical-align:top;">
							...
							<p style="margin:24px 0 8px; font-size:13px; font-weight:400; color:#5b5b5b;">
								<?php esc_html_e('Message', 'orange-county-handy'); ?>
							</p>
					...
					<tr>
						<td style="padding:16px 24px; background-color:#f9f9f9; border-top:1px solid #d3d3d3;">
							<p style="margin:0; font-size:12px; font-weight:400; color:#5b5b5b;">
								<?php printf(esc_html__('Sent from the contact form on %s', 'orange-county-handy'), '<a href="' . esc_url(home_url('/')) . '" style="color:#5b5b5b;">' . esc_html(wp_parse_url(home_url(), PHP_URL_HOST)) . '</a>'); ?>
							</p>
						</td>
					</tr>
